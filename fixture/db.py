    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                contact_list.append(Address_data(id=str(id), firstname=firstname, lastname=lastname, address=address,
                                                 home_phone=home, mobile_phone=mobile, work_phone=work, email_1=email,
                                                 email_2=email2))
        finally:
            cursor.close()
        return contact_list
