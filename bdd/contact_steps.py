...
def new_contact(firstname, middlename, lastname, address, email, phone):
    return Address_data(firstname=firstname, middlename=middlename, lastname=lastname, address=address, email_1=email,
                        home_page=phone)
...
def modify_data(firstname, middlename, lastname, address, email, phone):
    return Address_data(firstname=firstname, middlename=middlename, lastname=lastname,
                        address=address, email_1=email, home_phone=phone)


@when('I modify the contact from the list')
def modify_contact(app, random_contact, modify_data):
    #contact = modify_data
    app.group.modify_some_contact_by_id(modify_data, random_contact.id)
