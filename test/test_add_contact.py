...
def test_test_add_contact(app):
        ...
        app.group.add_new_address_form(Address_data(firstname="Jonny", middlename="Q", lastname="Cage", nickname="JQ", company="Andromeda", address="Moskow", home_phone="455-63-63",
